/**
 * Shared path constants and thresholds for all validators.
 */
...
/** Max body lines for an agent file before warning. */
export const MAX_BODY_LINES = 500;

/** Max instruction lines when applyTo uses '**' wildcard. */
export const MAX_LINES_WITH_WILDCARD = 50;

/** Max SKILL.md lines before requiring a references/ subfolder. */
export const MAX_SKILL_LINES_WITHOUT_REFS = 300;
