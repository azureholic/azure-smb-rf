/**
 * Canonical artifact H2 heading definitions.
 *
 * Single source of truth for required H2 headings per artifact file.
 * Used by validate-artifacts.mjs, validate-artifact-templates.mjs,
 * and the H2 sync validator.
 */
