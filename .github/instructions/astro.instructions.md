...
- Site URL: `https://jonathan-vella.github.io/azure-smb-rf/`
- Base path: `/azure-smb-rf`
...
- **Base path**: All asset references must account for `/azure-smb-rf/` base
- **Edit links**: Point to `https://github.com/jonathan-vella/azure-smb-rf/edit/main/site/`
