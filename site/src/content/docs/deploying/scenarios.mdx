...
> **Note**: Bastion Developer is an Azure portal capability — no infrastructure is deployed. It provides browser-based SSH/RDP to VMs via the portal without a dedicated Bastion host resource.
| Key Vault + PE               | ✅       | ✅       | ✅    | ✅    |
