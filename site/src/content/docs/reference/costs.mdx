...
<Aside type="tip">
  Estimates are for Sweden Central (swedencentral) as of 2026. Use the [Azure
  Pricing Calculator](https://azure.microsoft.com/pricing/calculator/) for
  current pricing.
</Aside>
...
<Aside type="note">
  The VPN Gateway uses the zone-redundant VpnGw1AZ SKU for higher availability.
  This costs approximately the same as VpnGw1 in Sweden Central.
</Aside>
