...
1. **Prepare your tenant**
   ...
   Create the `smb-rf` management group under your tenant root. This is a one-time operation that requires Global Admin or equivalent privileges.
   ...
   <Aside type="tip">
     If your organization restricts management group creation, run the `Setup-ManagementGroupPermissions.ps1` script first — it requires Global Admin consent.
   </Aside>
