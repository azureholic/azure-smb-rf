...
A single `azd up` command deploys a hub-spoke network topology with 34 governance policies, conditional networking (Firewall, VPN Gateway), and core operations services — all using Azure Verified Modules.
...
<CardGrid>
  ...
  <Card title="34 Governance Policies" icon="approve-check-circle">
    30 management group-scoped + 4 subscription-scoped Azure Policy assignments covering compute, network, storage, identity, tagging, Key Vault, monitoring, and backup.
  </Card>
